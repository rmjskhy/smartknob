...
void BleKeyboard::begin(void)
{
  ...
  inputRadial = hid->inputReport(RADIAL_ID);
  outputRadial = hid->outputReport(RADIAL_ID);
  featureRadial = hid->featureReport(RADIAL_ID);
  featureRadial->setCallbacks(new radialFeatureHapticCallback(this));
